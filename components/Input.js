...
const Input = () => {
   ...
   //SETING UP FIRE BASE (POSTING POSTs TO FIREBASE)
  ...
  return (
    <div className={`border-b border-gray-700 p-3 flex space-x-3 overflow  ${ loading && "opacity-60"}`}>
